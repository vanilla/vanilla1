<?
/**
 * Description: Create vanilla file md5 signatures;
 *  
 *
...
include_once 'src/library/Framework/Framework.Class.IntegrityChecker.php';
...
$Checker = new IntegrityChecker($build . '/appg/md5.csv', $build);
$Result = $Checker->Save();
