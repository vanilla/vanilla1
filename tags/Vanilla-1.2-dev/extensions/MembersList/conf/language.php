...
$Context->SetDefinition('permission_view',        'MembersList: Can see the Members tab');
$Context->SetDefinition('permission_view_secret', 'MembersList: Can see names and email addresses on the Members tab');
?>