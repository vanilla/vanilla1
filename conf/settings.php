...
*
* Description: Define your custom settings here. 
*/
// Database Settings
$Configuration["DATABASE_HOST"] = "localhost"; 
$Configuration["DATABASE_NAME"] = "pld8"; 
$Configuration["DATABASE_USER"] = "root"; 
$Configuration["DATABASE_PASSWORD"] = "thing"; 

// Path Settings
$Configuration["APPLICATION_PATH"] = "c:/applications/lussumo/vanilla/"; 
$Configuration["LIBRARY_PATH"] = "c:/applications/lussumo/GlobalLibrary/"; 
...
$Configuration["REWRITE_BASE_URL"] = "http://astroboy:8020/vanilla/"; 
