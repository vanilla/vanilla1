...
// 2. BUILD PAGE CONTROLS
	...
	if ($Context->Session->UserID > 0) {
		...
		$Panel->AddListItem($Options,
			...
			"./",
			"",
			"id=\"SetBookmark\" onclick=\"SetBookmark('".$Configuration['WEB_ROOT']."ajax/switch.php', ".$CommentGrid->Discussion->Bookmarked.", '".$CommentGrid->Discussion->DiscussionID."', '".$Context->GetDefinition("BookmarkText")."', '".$Context->GetDefinition("UnbookmarkThisDiscussion")."', '".$Context->GetDefinition('Processing')."'); return false;\"");
