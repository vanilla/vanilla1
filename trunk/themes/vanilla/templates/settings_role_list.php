         ...
         if ($this->RoleData) {
            ...
            while ($Row = $this->Context->Database->GetRow($this->RoleData)) {
               ...
               echo("<li class=\"SortListItem MovableSortListItem\" id=\"item_".$r->RoleID."\">
                  <a class=\"SortRemove\" href=\"./settings.php?PostBackAction=RoleRemove&RoleID=".$r->RoleID."\"><img src=\"".$this->Context->StyleUrl."images/btn.remove.gif\" height=\"15\" width=\"15\" border=\"0\" alt=\"".$this->Context->GetDefinition("Remove")."\" /></a>
                  <a class=\"SortEdit\" href=\"./settings.php?PostBackAction=Role&RoleID=".$r->RoleID."\">".$this->Context->GetDefinition("Edit")."</a>
                  ".$r->RoleName."
               </li>");
            }
         }
