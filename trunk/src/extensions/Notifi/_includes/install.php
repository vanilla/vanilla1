<?php
	...
	if (empty($Configuration['NOTIFI_INSTALL_V3_COMPLETE'])) {
		...
		$NotifiCreate = "CREATE TABLE IF NOT EXISTS `".$Context->Configuration['DATABASE_TABLE_PREFIX']."Notifi` (
		...
		if (mysql_num_rows($result) == 0) {
			$NotifiCreate = "ALTER TABLE `".$Context->Configuration['DATABASE_TABLE_PREFIX']."User`
