...
echo("<div class=\"SettingsForm\">
   ...
   <div class=\"Form\" id=\"Roles\">
         ...
         if ($this->RoleData) {
            ...
            while ($Row = $this->Context->Database->GetRow($this->RoleData)) {
               ...
               echo("<li class=\"SortListItem MovableSortListItem\" id=\"item_".$r->RoleID."\">
                  <a class=\"SortRemove\" href=\"./".$this->Context->SelfUrl."?PostBackAction=RoleRemove&RoleID=".$r->RoleID."\"><img src=\"".$this->Context->StyleUrl."images/btn.remove.gif\" height=\"15\" width=\"15\" border=\"0\" alt=\"".$this->Context->GetDefinition("Remove")."\" /></a>
                  <a class=\"SortEdit\" href=\"./".$this->Context->SelfUrl."?PostBackAction=Role&RoleID=".$r->RoleID."\">".$this->Context->GetDefinition("Edit")."</a>
                  ".$r->RoleName."
               </li>");
            }
         }
      ...
      <div class=\"FormLink\"><a href=\"".$this->Context->SelfUrl."?PostBackAction=Role\">".$this->Context->GetDefinition("CreateANewRole")."</a></div>
   </div>
</div>");
?>